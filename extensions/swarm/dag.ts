// ============================================================================
// DAG operations — адаптировано из oh-my-pi/packages/swarm-extension
//
// Builds dependency graph from waits_for / reports_to, detects cycles,
// produces execution waves via topological sort (Kahn's algorithm).
// ============================================================================
